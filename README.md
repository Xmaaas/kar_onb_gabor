# `karacsonygabor_package` package
...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/Xmaaas/karacsonygabor_package/generate) / [`Create new repository`](https://github.com/Xmaaas/karacsonygabor_package/generate). 
...
- `karacsonygabor_package` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `Xmaaas` >> `mycoolusername`
