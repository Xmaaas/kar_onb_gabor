...
{
public:
    eredmeny() : Node("eredmeny"), val1received(false), val2received(false)
    {
        RCLCPP_INFO(this->getlogger(), "Koszinusz jelek eredménye");
        pub = this->create_publisher<stdmsgs::msg::Float32>("eredmeny", 10);
        sub1 = this->create_subscription<std_msgs::msg::Float32>( "cos1", 10,std::bind(&eredmeny::callback1, this, std::placeholders::1));
        sub2 = this->create_subscription<std_msgs::msg::Float32>("cos2", 10,std::bind(&eredmeny::callback2, this, std::placeholders::_1));
    }
